...
urlpatterns = [
    ...
    path('initiatives',
         ...
         name='initiative_list_create_view'),
    path('initiatives/<uuid:initiative_id>',
         InitiativeDetailUpdateView.as_view(),
         name='initiative_detail_update'),
    path('initiatives/<uuid:initiative_id>/advance-stage',
         AdvanceInitiativeStageView.as_view(),
         name='advance_initiative_stage'),
    path('initiatives/<uuid:initiative_id>/handover',
         InitiativeHandoverView.as_view(),
         name='initiative_handover'),

    # ------------------------------
    # Urls for Initiative Documents
    # ------------------------------
